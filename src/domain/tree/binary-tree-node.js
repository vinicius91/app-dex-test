...
export default class BinaryTreeNode {
  /**
   * @param {AppModel} [value] - node value.
   */
  constructor(value = null) {
    ...
    this.nodeComparator = new Comparator(BinaryTreeNode.comparator);
  }
  ...
  static comparator(a, b) {
    ...
    return AppModel.comparator(first, second);
  }
  ...
  toString() {
    return this.traverseInOrder()
      ...
      .reduce((pre, crr) => `${pre !== '' ? pre + ',' : pre}${crr}`, '');
  }
}
